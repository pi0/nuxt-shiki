...
describe('nuxt-shiki', async () => {
  ...
  it('ssr works <Shiki> component', async () => {
    ...
    expect(body).toMatchInlineSnapshot(`"<pre><code class="shiki min-light" style="background-color:#ffffff;color:#24292eff" tabindex="0"><span class="line"><span style="color:#1976D2">console</span><span style="color:#6F42C1">.log</span><span style="color:#24292EFF">(</span><span style="color:#22863A">'hello'</span><span style="color:#24292EFF">);</span></span></code></pre>"`)
  })
